	...
	var _={
			config:{
				...
				cache:{elements:{},
					...
					lsc:"_skel_lock",
					sd:" ",
					css:{r:"html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1}ol,ul{list-style:none}blockquote,q{quotes:none}blockquote:before,blockquote:after,q:before,q:after{content:'';content:none}table{border-collapse:collapse;border-spacing:0}body{-webkit-text-size-adjust:none}",
						...
						presets:{"default":{},standard:{
							breakpoints:{
								mobile:{
									range:"-480",lockViewport:!0,containers:"fluid",grid:{collapse:1,gutters:10}},
									...
									defaults:{breakpoint:{test:null,config:null,elements:null},
										config_breakpoint:{range:"",containers:960,lockViewport:!1,viewportWidth:!1,viewport:"",hasStyleSheet:!0,grid:{}}},
										DOMReady:null,getElementsByClassName:null,indexOf:null,iterate:null,extend:function(e,t){
											var n="object",r;_.iterate(t,function(r){typeof t[r]==n?(typeof e[r]!=n&&(e[r]={}),_.extend(e[r],t[r])):e[r]=t[r]})},parseMeasurement:function(e){
												var t,n;if(typeof e!="string")t=[e,"px"];
												...
												getDevicePixelRatio:function(){
													...
													if(window[t]!==undefined&&!r.match(/(Firefox; Mobile)/))
														return window[t];
													if(window[n]){
														if(window[n]("(-webkit-min-device-pixel-ratio: 2)," +
																"(min--moz-device-pixel-ratio: 2)," +
																"(-o-min-device-pixel-ratio: 2/1)," +
																"(min-resolution: 2dppx)").matches)
															return 2;
														if(window[n]("(-webkit-min-device-pixel-ratio: 1.5)," +
													...
													getLevel:function(e){
														...
														getViewportWidth:function(){
															...
															return r=document.documentElement.clientWidth,i=window[e]!==undefined?Math.abs(window[e]):!1,s=_.getDevicePixelRatio(),
																	screen[t]<r&&(r=screen[t]),i!==!1&&(_.config.useOrientation?i===90?r=Math.max(screen[t],screen[n]):r=Math.min(screen[t],screen[n]):r=Math.min(screen[t],screen[n])),r/=s,r}
														,unlock:function(){_.lockState=null,document.cookie=_.lsc+"=;expires=Thu, 1 Jan 1970 12:00:00 UTC; path="+(_.config.useDomainLock?"/":window.location.pathname),
															_.config.pollOnLock?_.poll():window.location.reload()},
															lock:function(e){_.lockState=e,document.cookie=_.lsc+"="+e+";expires="+(_.config.usePerpetualLock?"Thu, 1 Jan 2077 12:00:00 UTC":0)+"; path="+(_.config.useDomainLock?"/":window.location.pathname),_.config.pollOnLock?_.poll():window.location.reload()},
															getLock:function(){
																return _.lockState},
																isLocked:function(){return!!_.lockState},
																hasActive:function(e){
																	var t=!1;return _.iterate(e,function(n){t=t||_.isActive(e[n])}),t},
																	isActive:function(e){return _.indexOf(_.stateId,_.sd+e)!==-1},
																	wasActive:function(e){return _.indexOf(_.vars.lastStateId,_.sd+e)!==-1},
																	canUse:function(e){return _.breakpoints[e]&&_.breakpoints[e].test(_.getViewportWidth())},
																	unreverseRows:function(){
																		var e="_skel_isReversed",
																		t=_.getElementsByClassName("row");
																		_.iterate(t,function(n){if(n==="length")
																			return;
																		var r=t[n];
																		if(!r[e])return;
																		var i=r.children,
																		s;
																		for(s=1;s<i.length;s++)r.insertBefore(i[s],i[0]);r[e]=!1})},
																		reverseRows:function(e){
																			...
																			_.iterate(n,function(r){
																				...
																				var s=i.children,o;for(o=1;o<s.length;o++)i.insertBefore(s[o],s[0]);i[t]=!0})},
																				bind:function(e,t){_.events[e]||(_.events[e]=[]),_.events[e].push(t)},
																				trigger:function(e){var t="events";
																				if(!_[t][e]||_[t][e].length==0)
																					return;
																				var n;
																				_.iterate(_[t][e],function(n){_[t][e][n]()})},
																				onStateChange:function(e){_.bind("stateChange",e),
																					_.isInit&&e()},registerLocation:function(e,t){
																						var n="_skel_attach",r="appendChild";
																						e=="head"?t[n]=function(e){this===_.me.parentNode?this.insertBefore(e,_.me):this[r](e)}:t[n]=function(e){this[r](e)},_.locations[e]=t},cacheElement:function(e,t,n,r){
